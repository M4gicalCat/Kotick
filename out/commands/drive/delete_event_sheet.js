...
export default {
    ...
    async execute(interaction) {
        ...
        const googleEvent = (_a = e.description.match(/kotick@\w*/)) === null || _a === void 0 ? void 0 : _a[0].split('@')[1];
        if (!googleEvent) {
            return interaction.editReply({
                content: `L'événement n'est pas relié à un événement google`,
            });
        }
        await db.none(`UPDATE discord.event SET sheet_id = NULL WHERE event_id = $1 AND guild_id = $2`, [googleEvent, interaction.guildId]);
