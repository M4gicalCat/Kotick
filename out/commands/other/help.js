...
export default {
    ...
    async execute(interaction) {
        var _a;
        const category = (_a = interaction.options.getString('category')) !== null && _a !== void 0 ? _a : 'help';
        const fields = [];
        switch (category) {
            case 'server':
                fields.push(...[
            ...
            default:
                fields.push(...[
                    {
                        name: '`**AIDE**`',
                        value: "Utilisez `/help` avec une option pour voir l'aide relative à sa catégorie.",
                    },
                    { name: '\u200B', value: '\u200B' },
                    {
                        name: 'Mise en place du serveur',
                        value: 'Pour mettre en place rapidement le bot sur le serveur il faut :',
                    },
                    {
                        name: '`/init_server`',
                    ...
                    {
                        name: '`/channel_eclais`',
                        value: 'Cette commande définit le channel pour les rappels éclais. Elle est à utiliser dans le channel correspondant',
                    },
                    {
                        name: '`/channel_responsables`',
                        value: 'Cette commande définit le channel pour les rappels responsables. Elle est à utiliser dans le channel correspondant',
                    },
                    { name: '\u200B', value: '\u200B' },
                    {
